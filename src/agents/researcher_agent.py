...
from src.utilities.util_functions import list_directory_tree, read_project_rules
...
class Researcher():
    ...
    def research_task(self, task):
        ...
        system_message = system_prompt_template.format(task=task, project_rules=read_project_rules())
        inputs = {
